...
public class DBHelper {
  ...
  private static final String PRODUCT_NAME = "name AS product_name";//la till as product_name så vi byter kolumnens namn
  ...
  private static final String PRODUCT_GROUP = "name AS product_group";//samma som kolumnen name
