...
//FlowLayout panel i FlowLayout
  ...
  private void init() {
    ...
    GridLayout formLayout = new GridLayout(6,4);
    ...
    textFields = Arrays.asList(minPriceField, maxPriceField, minAlcoField, maxAlcoField);
